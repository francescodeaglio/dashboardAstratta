...
from dashboard_abstract.utils import articoli_regioni_no_in, transform_regions_pc_to_human, list_mesi
...
class DashboardReport(DashboardChart):
    ...
    def show_heading(self):
        ...
        str1 = str1 + "\n Aprendo l'expander, è possibile visualizzare ulteriori dati "+transform_regions_pc_to_human(regione=self.regione)+". "
        self.subtitle = str1
