...
class ChartWidget(DashboardChart):
    ...
    def show(self):
        ...
        st.write("*" + text + "*")
        text = "**Attraverso il parametro widget_list del costruttore**"
        st.write(text)
...
wl = [ partial(st.selectbox, "Come è il meteo oggi?", ["soleggiato", "nuvoloso"]), 
        ...
        text = "*Uno dei parametri facoltativi del costruttore è la widget_object, ovvero un oggetto della classe DashboardWidgets. Questa classe ha" \
               " come parametro del costruttore widget_list e il comportamento è analogo al caso precedente. Altrimenti, si può istanziare un oggetto vuoto e aggiungere" \
